...
// Profesyonel Cizgi Izleyen - Fanli PID'siz Taslak
...
void solaDuzelt() {
  ...
  digitalWrite(sagMotor2, LOW);
  analogWrite(solMotor1, 70);
  digitalWrite(solMotor2, LOW);
}

void sagaDuzelt() {
  analogWrite(sagMotor1, 70);
  digitalWrite(sagMotor2, LOW);
...
void solaHafifDuzelt() {
  ...
  digitalWrite(sagMotor2, LOW);
  analogWrite(solMotor1, normalHiz - 45);
  digitalWrite(solMotor2, LOW);
}

void sagaHafifDuzelt() {
  analogWrite(sagMotor1, normalHiz - 45);
  digitalWrite(sagMotor2, LOW);
